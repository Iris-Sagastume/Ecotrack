...
builder.Services.AddSwaggerGen(c =>
{
    ...
    c.OperationFilter<AuthorizeCheckOperationFilter>(); // Solo aplica seguridad a endpoints con [Authorize]
});

    // Elimina el AddSecurityRequirement global
    // Si quieres agregar seguridad solo a endpoints específicos, puedes usar filtros o anotaciones en el controlador
